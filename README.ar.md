...
| تصميم القالب | نمط الهيرو | تجربة الفيلم | حالات الاستخدام الرئيسية |
| :--- | :--- | :--- | :--- |
| **`fullbleed.html`** | عنصر بطل مقطوع + هالة | فيلم تحول طويل (640vh) | المنتجات الفاخرة، الإطلاقات الكبرى، إعادة إطلاق العلامات، السيارات، الساعات |
| **`editorial.html`** | شاشة مقسمة (صورة + نص) | فيلم قصة مركز (420vh) | قصص العلامات، الفعاليات، المؤتمرات، قصص المؤسسين |
| **`spatial.html`** | لقطة تأسيسية كاملة | فيلم جولة مكاني (500vh) | العقارات، الهندسة المعمارية، السفر الفاخر، الضيافة |
| **`interface.html`** | إطار واجهة جهاز | فيلم تدفق الواجهات (420vh) | إطلاق منصات SaaS، التطبيقات، المنصات الرقمية |
| **`minimal.html`** | عنصر بطل خلفية نظيفة | مبني على الأقسام (بدون فيلم) | العلامات الشخصية، صناع المحتوى، الكتب الرقمية |
